...
function initShareButton() {
  ...
  fab.addEventListener('click', function () {
    var shareData = {
      title: CONFIG.companyName + ' — Taxi Booking',
      text: 'Book a reliable taxi in Abbottabad at transparent per-km rates with ' + CONFIG.companyName + '!',
...
function openSharePopup() {
  ...
  var text = encodeURIComponent('Book a reliable taxi in Abbottabad at transparent per-km rates with ' + CONFIG.companyName + '! ' + url);
