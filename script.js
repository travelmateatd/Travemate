...
function initRaffle() {
  var section = document.getElementById('raffle');
  ...
  // Bonus entry share button — uses raffle-specific share wording
  var shareBtn = document.getElementById('raffleShareBtn');
  if (shareBtn) {
    shareBtn.addEventListener('click', function () {
      triggerShare(
        CONFIG.companyName + ' — Cashback Raffle',
        'I just booked a taxi with ' + CONFIG.companyName + ' and entered their monthly cashback raffle (win ' + RAFFLE.prize + ')! Book your ride here and join too:'
      );
    });
  }
}
